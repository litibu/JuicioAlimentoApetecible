...
graph TD
    A["Acto 1: Apertura del Juicio y Acusación Formal"] 
      --> B["Acto 2: Antecedentes e Historia de los Extractos Vegetales"]
    B --> C["Acto 3: Pruebas de la Fiscalía - Profeco, Agua con Gomas, Picos Glucémicos y Costo"]
    C --> D["Acto 4: Alegatos de la Defensa - APLV, Digestibilidad, Cero Colesterol y Déficit Calórico"]
    D --> E["Acto 5: Careo y Contraste de Datos Duros - Tabla Comparativa por Origen Vegetal"]
